...
AR Path="/5F3A5B71" Ref="U1"  Part="4" 
...
AR Path="/5F3CEA6B" Ref="U1"  Part="7" 
...
AR Path="/5F3D4214" Ref="U1"  Part="8" 
...
AR Path="/5F3DE432" Ref="U1"  Part="9" 
...
GPIO4
Text HLabel 2200 7275 2    50   Output ~ 0
COM_SPI_SIMO
Text HLabel 4550 725  2    50   Input ~ 0
COM_SPI_SOMI
...
ESC_RX0_DV
Text Label 8875 2925 0    50   ~ 0
ESC_RX0_CLK
Text Label 8875 3025 0    50   ~ 0
ESC_RX0_ERR
Text Label 8875 3275 0    50   ~ 0
ESC_RX0_D0
...
Wire Wire Line
	8850 4575 9750 4575
Text Label 8875 4175 0    50   ~ 0
ESC_PHY1_LINKSTATUS
Text Label 8875 4075 0    50   ~ 0
ESC_PHY0_LINKSTATUS
Text Label 8875 4675 0    50   ~ 0
ESC_LED_LINK1_ACTIVE
Text Label 8875 4575 0    50   ~ 0
ESC_LED_LINK0_ACTIVE
Wire Wire Line
	9400 5025 8850 5025
...
AR Path="/5F3C0127" Ref="U1"  Part="6" 
...
Wire Wire Line
	4550 2725 4500 2725
Text HLabel 8900 5425 2    50   Output ~ 0
ANALOG_IN2
...
F6 "ESC_TX0_D3" I R 8850 2775 50 
F7 "ESC_TX0_D2" I R 8850 2675 50 
F8 "ESC_TX0_D1" I R 8850 2575 50 
F9 "ESC_TX0_D0" I R 8850 2475 50 
...
F14 "ESC_RX0_D0" O R 8850 3275 50 
F15 "ESC_RX0_D1" O R 8850 3375 50 
F16 "ESC_RX0_D2" O R 8850 3475 50 
F17 "ESC_RX0_D3" O R 8850 3575 50 
F18 "ESC_RX1_DV" O R 8850 1625 50 
F19 "ESC_RX1_CLK" O R 8850 1425 50 
F20 "ESC_RX0_DV" O R 8850 3125 50 
F21 "ESC_RX0_ERR" O R 8850 3025 50 
F22 "ESC_RX0_CLK" O R 8850 2925 50 
F23 "ESC_TX1_ENA" I R 8850 825 50 
F24 "ESC_TX0_CLK" O R 8850 2225 50 
F25 "~ESC_PHY_RESETn~" I R 8850 3925 50 
F26 "ESC_I2C_SDA" B R 8850 4325 50 
F27 "ESC_I2C_SCL" I R 8850 4425 50 
F28 "ESC_LED_LINK0_ACT" I R 8850 4575 50 
F29 "ESC_LED_LINK1_ACT" I R 8850 4675 50 
F30 "ESC_LED_ERR" I R 8850 4775 50 
F31 "ESC_LED_RUN" I R 8850 4875 50 
F32 "ESC_PHY0_LINKSTATUS" O R 8850 4075 50 
F33 "ECAT0_INT" I R 8850 5025 50 
F34 "ESC_TX0_ENA" I R 8850 2325 50 
F35 "ESC_PHY_MDIO_DATA" B R 8850 3825 50 
F36 "ESC_PHY_MDIO_CLK" I R 8850 3725 50 
F37 "ECAT1_INT" I R 8850 5125 50 
F38 "ESC_PHY1_LINKSTATUS" O R 8850 4175 50 
F39 "ANALOG_IN" O R 8850 5425 50 
F40 "ESC_TX1_CLK" O R 8850 725 50 
F41 "ESC_RX1_ERR" O R 8850 1525 50 
F42 "~SPI_CS2n~" I R 8850 5625 50 
F43 "SPI_SOMI" O R 8850 5925 50 
F44 "~SPI_CS1n~" I R 8850 5725 50 
F45 "SPI_CLK" I R 8850 6025 50 
F46 "SPI_SIMO" I R 8850 5825 50 
F47 "25MHz_OSC_CLK" I R 8850 5325 50 
$EndSheet
NoConn ~ 4500 1625
Text HLabel 4550 2125 2    50   BiDi ~ 0
GPIO0
Text HLabel 4550 2525 2    50   BiDi ~ 0
GPIO2
Wire Wire Line
	4550 2525 4500 2525
Text HLabel 4550 2425 2    50   BiDi ~ 0
GPIO3
Text HLabel 8900 5825 2    50   Input ~ 0
SPI_SIMO
Text HLabel 8900 5925 2    50   Output ~ 0
SPI_SOMI
Text HLabel 8900 6025 2    50   Input ~ 0
SPI_CLK
Text HLabel 8900 5725 2    50   Input ~ 0
~SPI_CSn~_BOOT_MODE1
Text HLabel 8900 5325 2    50   Input ~ 0
25MHz_OSC_SRC_IN
NoConn ~ 2150 5775
Wire Wire Line
	8900 6025 8850 6025
...
AR Path="/5F3AD210" Ref="U1"  Part="5" 
...
F 6 "F28388DZWTS" H 1500 6075 50  0001 C CNN "Part No"
	...
	1    0    0    -1  
$EndComp
Text HLabel 4550 925  2    50   Output ~ 0
~COM_SPI_CSn~
NoConn ~ 2150 6875
NoConn ~ 2150 6975
NoConn ~ 2150 7075
