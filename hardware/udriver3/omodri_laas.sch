...
U 1 1 5F556FE6
P 2800 3650
F 0 "J1" H 2900 4175 50  0000 C CNN
F 1 "Conn_01x11" H 2800 3050 50  0000 C CNN
F 2 "udriver3:Hirose_DF13-11P-1.25DSA_1x11_P1.25mm_Vertical" H 2800 3650 50  0001 C CNN
F 3 "https://www.hirose.com/product/document?clcode=&productname=&series=DF13&documenttype=Catalog&lang=en&documentid=D31687_en" H 2800 3650 50  0001 C CNN
F 4 "DF13-11P-1.25DSA-ND" H 2800 3650 50  0001 C CNN "DigiKey"
F 5 "798-DF13-11P-1.25DSA" H 2800 3650 50  0001 C CNN "Mouser"
F 6 "DF13-11P-1.25DSA" H 2800 3650 50  0001 C CNN "Part No"
F 7 "" H 2800 3650 50  0001 C CNN "RS"
	1    2800 3650
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5F58128E
P 2800 4650
F 0 "J2" H 2800 4950 50  0000 C CNN
F 1 "Conn_01x05" H 2800 4350 50  0000 C CNN
F 2 "udriver3:Hirose_DF13-05P-1.25DSA_1x05_P1.25mm_Vertical" H 2800 4650 50  0001 C CNN
F 3 "https://www.hirose.com/product/document?clcode=&productname=&series=DF13&documenttype=Catalog&lang=en&documentid=D31687_en" H 2800 4650 50  0001 C CNN
F 4 "H2194-ND" H 2800 4650 50  0001 C CNN "DigiKey"
F 5 "2427589" H 2800 4650 50  0001 C CNN "Farnell"
F 6 "798-DF13-5P-1.25DSA" H 2800 4650 50  0001 C CNN "Mouser"
F 7 "DF13-5P-1.25DSA" H 2800 4650 50  0001 C CNN "Part No"
F 8 "503-7912" H 2800 4650 50  0001 C CNN "RS"
	1    2800 4650
	-1   0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR06" H 3100 4200 50  0001 C CNN
...
F13 "COM_SPI_SIMO" O L 3600 4850 50 
F14 "COM_SPI_SOMI" I L 3600 4650 50 
F15 "COM_SPI_CLK" O L 3600 4750 50 
...
F52 "~COM_SPI_CSn~" O L 3600 4550 50 
F53 "WS2812B_CMD" O L 3600 5475 50 
...
F59 "SPI_SIMO" O L 3600 3650 50 
F60 "SPI_SOMI" I L 3600 3450 50 
F61 "SPI_CLK" O L 3600 3550 50 
F62 "FSI_RXC_CLK" I L 3600 2200 50 
F63 "FSI_RXC_D0" I L 3600 2300 50 
F64 "FSI_RXC_D1" I L 3600 2400 50 
F65 "F2838x_CLK_25MHz" I L 3600 6225 50 
F66 "USB0_N" B L 3600 5150 50 
F67 "USB0_P" B L 3600 5050 50 
F68 "~SPI_CSn~_BOOT_MODE1" O L 3600 3350 50 
F69 "BOOT_MODE0" U L 3600 3050 50 
$EndSheet
$Comp
...
F2 "F2838x_CLK_25MHz" O R 3150 6225 50 
$EndSheet
$Sheet
S 2300 5400 1100 150 
U 5F9FCB8C
F0 "OMODRI_LED_dbg" 50
F1 "OMODRI_LED_dbg.sch" 50
F2 "WS2812B_CMD" I R 3400 5475 50 
$EndSheet
$Sheet
S 2300 5750 1100 175 
U 5F9E8B4A
F0 "OMODRI_POWER_CAP" 50
F1 "OMODRI_POWER_CAP.sch" 50
F2 "V_Bus" O R 3400 5800 50 
$EndSheet
NoConn ~ 1500 5250
$Comp
L power:GND #PWR?
...
F 0 "#PWR047" H 1200 5350 50  0001 C CNN
...
F 0 "C25" H 1225 4400 50  0000 L CNN
F 1 "100nF" H 1225 4325 50  0000 L CNN
F 2 "Capacitor_SMD:C_0201_0603Metric" H 1638 4225 50  0001 C CNN
F 3 "https://www.murata.com/en-eu/products/productdetail?partno=GRM033C71A104KE14%23" H 1600 4375 50  0001 C CNN
F 4 "GRM033C71A104KE14D" H 1600 4375 50  0001 C CNN "Part No"
F 5 "10V" H 1600 4375 50  0001 C CNN "Rated Voltage"
F 6 "2990681" H 1600 4375 50  0001 C CNN "Farnell"
F 7 "185-1751" H 1600 4375 50  0001 C CNN "RS"
F 8 "81-GRM033C71A104KE4D" H 1600 4375 50  0001 C CNN "Mouser"
F 9 "490-14450-1-ND" H 1600 4375 50  0001 C CNN "DigiKey"
	1    1600 4375
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FB9EA99
P 1200 5050
F 0 "J14" H 1200 5500 50  0000 C CNN
F 1 "USB_B_Micro" H 1200 5400 50  0000 C CNN
F 2 "udriver3:USB_Micro-B_Molex_47346-0001" H 1350 5000 50  0001 C CNN
F 3 "https://www.molex.com/molex/products/part-detail/io_connectors/0473460001" H 1350 5000 50  0001 C CNN
F 4 "WM17141CT-ND" H 1200 5050 50  0001 C CNN "DigiKey"
F 5 "1568026" H 1200 5050 50  0001 C CNN "Farnell"
F 6 "538-47346-0001" H 1200 5050 50  0001 C CNN "Mouser"
F 7 "473460001" H 1200 5050 50  0001 C CNN "Part No"
F 8 "702-5475" H 1200 5050 50  0001 C CNN "RS"
	1    1200 5050
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR04" H 1600 3925 50  0001 C CNN
F 1 "GND" V 1600 3975 50  0000 C CNN
...
U 1 1 5FC251D7
P 1875 5400
F 0 "D15" H 1963 5446 50  0000 L CNN
F 1 "ESD321" H 1963 5355 50  0000 L CNN
F 2 "udriver3:D_0402_1005Metric" H 2575 5150 50  0001 C CNN
F 3 "https://www.ti.com/lit/ds/symlink/esd321.pdf" V 1875 5400 50  0001 C CNN
F 4 "296-51108-1-ND" H 1875 5400 50  0001 C CNN "DigiKey"
F 5 "595-ESD321DPYR" H 1875 5400 50  0001 C CNN "Mouser"
F 6 "ESD321DPYR" H 1875 5400 50  0001 C CNN "Part No"
	1    1875 5400
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FC34CE1
P 1875 4800
F 0 "D14" H 1675 4850 50  0000 L CNN
F 1 "ESD321" H 1475 4750 50  0000 L CNN
F 2 "udriver3:D_0402_1005Metric" H 2575 4550 50  0001 C CNN
F 3 "https://www.ti.com/lit/ds/symlink/esd321.pdf" V 1875 4800 50  0001 C CNN
F 4 "296-51108-1-ND" H 1875 4800 50  0001 C CNN "DigiKey"
F 5 "595-ESD321DPYR" H 1875 4800 50  0001 C CNN "Mouser"
F 6 "ESD321DPYR" H 1875 4800 50  0001 C CNN "Part No"
	1    1875 4800
	-1   0    0    1   
$EndComp
$Comp
...
F 0 "#PWR048" H 1875 5350 50  0001 C CNN
F 1 "GND" V 1875 5400 50  0000 C CNN
...
F 0 "#PWR022" H 1875 4350 50  0001 C CNN
F 1 "GND" V 1875 4400 50  0000 C CNN
...
F 0 "R64" H 2570 3546 50  0000 L CNN
F 1 "10k" H 2570 3455 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 2430 3500 50  0001 C CNN
F 3 "https://industrial.panasonic.com/cdbs/www-data/pdf/RDA0000/AOA0000C304.pdf" H 2500 3500 50  0001 C CNN
F 4 "P122414CT-ND" H 2500 3500 50  0001 C CNN "DigiKey"
F 5 "2302362" H 2500 3500 50  0001 C CNN "Farnell"
F 6 "667-ERJ-1GNF1002C" H 2500 3500 50  0001 C CNN "Mouser"
F 7 "ERJ-1GNF1002C" H 2500 3500 50  0001 C CNN "Part No"
F 8 "176-3597" H 2500 3500 50  0001 C CNN "RS"
	1    2500 3500
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "R20" H 2295 3546 50  0000 L CNN
F 1 "10k" H 2295 3455 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 2155 3500 50  0001 C CNN
F 3 "https://industrial.panasonic.com/cdbs/www-data/pdf/RDA0000/AOA0000C304.pdf" H 2225 3500 50  0001 C CNN
F 4 "P122414CT-ND" H 2225 3500 50  0001 C CNN "DigiKey"
F 5 "2302362" H 2225 3500 50  0001 C CNN "Farnell"
F 6 "667-ERJ-1GNF1002C" H 2225 3500 50  0001 C CNN "Mouser"
F 7 "ERJ-1GNF1002C" H 2225 3500 50  0001 C CNN "Part No"
F 8 "176-3597" H 2225 3500 50  0001 C CNN "RS"
	1    2225 3500
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR060" H 2225 3450 50  0001 C CNN
F 1 "GND" V 2225 3500 50  0000 C CNN
...
F 0 "R12" H 2020 3546 50  0000 L CNN
F 1 "10k" H 2020 3455 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 1880 3500 50  0001 C CNN
F 3 "https://industrial.panasonic.com/cdbs/www-data/pdf/RDA0000/AOA0000C304.pdf" H 1950 3500 50  0001 C CNN
F 4 "P122414CT-ND" H 1950 3500 50  0001 C CNN "DigiKey"
F 5 "2302362" H 1950 3500 50  0001 C CNN "Farnell"
F 6 "667-ERJ-1GNF1002C" H 1950 3500 50  0001 C CNN "Mouser"
F 7 "ERJ-1GNF1002C" H 1950 3500 50  0001 C CNN "Part No"
F 8 "176-3597" H 1950 3500 50  0001 C CNN "RS"
	1    1950 3500
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "R11" H 1745 3546 50  0000 L CNN
F 1 "10k" H 1745 3455 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 1605 3500 50  0001 C CNN
F 3 "https://industrial.panasonic.com/cdbs/www-data/pdf/RDA0000/AOA0000C304.pdf" H 1675 3500 50  0001 C CNN
F 4 "P122414CT-ND" H 1675 3500 50  0001 C CNN "DigiKey"
F 5 "2302362" H 1675 3500 50  0001 C CNN "Farnell"
F 6 "667-ERJ-1GNF1002C" H 1675 3500 50  0001 C CNN "Mouser"
F 7 "ERJ-1GNF1002C" H 1675 3500 50  0001 C CNN "Part No"
F 8 "176-3597" H 1675 3500 50  0001 C CNN "RS"
	1    1675 3500
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR049" H 1675 3450 50  0001 C CNN
F 1 "GND" V 1675 3500 50  0000 C CNN
