...
#ifndef __UOMODRI_2_HAL_DEFINES_H__
#define __UOMODRI_2_HAL_DEFINES_H__
...
#elif (!RS485_BUS_ENABLE && CAN_BUS_ENABLE)
#define CAN_TX_NUM                              (12U)
...
#define IMU_IT3_NUM                             (34U)
#define IMU_IT3_CFG                             GPIO_34_GPIO34
#define IMU_IT3_READ                            (HWREG(GPIODATA_BASE + GPIO_O_GPBDAT) & GPIO_GPBDAT_GPIO34)
...
#define IMU_EXT_DBG_SPI_CS_NUM                  (72U)
#define IMU_EXT_DBG_SPI_CS_CFG                  GPIO_72_GPIO72
#define IMU_EXT_DBG_SPI_CS_SET                  (HWREG(GPIODATA_BASE + GPIO_O_GPCSET)   = GPIO_GPCSET_GPIO72)
#define IMU_EXT_DBG_SPI_CS_CLEAR                (HWREG(GPIODATA_BASE + GPIO_O_GPCCLEAR) = GPIO_GPCCLEAR_GPIO72)
#define IMU_EXT_DBG_SPI_CS_TOGGLE               (HWREG(GPIODATA_BASE + GPIO_O_GPCTOGGLE)= GPIO_GPCTOGGLE_GPIO72)
...
#define RS485_RX_EN_DEF                         { \
                                                    .pinNum         = RS485_RX_EN_NUM, \
                                                    .fctMux         = RS485_RX_EN_CFG, \
                                                    .pinType        = GPIO_PIN_TYPE_OD, \
                                                    .direction      = GPIO_DIR_MODE_OUT, \
                                                    .samplingInMode = GPIO_QUAL_ASYNC, \
                                                    .setValue       = false, \
...
#define ADC_MOTOR_CURRENT_SCALE                 (ADC_VREF * (-1.0f) / \
                                                 DRV_CSA_GAIN_VAL / R_SHUNT / \
                                                 ADC_RESOLUTION_MAX)
/**
 * @}
 */
...
#define COM_SCI_CFG                             (SCI_CONFIG_WLEN_8 | \
                                                 SCI_CONFIG_STOP_ONE | \
                                                 SCI_CONFIG_PAR_NONE)
...
#define DMA_LED_SPI_TX_FULL_LENGTH              (6)
#define DMA_LED_SPI_TX_BURST_EVT                (3)
...
#define DMA_COM_SPI_TX_RX_FULL_LENGTH           (17)
#define DMA_COM_SPI_TX_RX_CRC_LENGTH            (2)
#define DMA_COM_SPI_TX_RX_PAYLOAD_LENGTH        (DMA_COM_SPI_TX_RX_FULL_LENGTH - DMA_COM_SPI_TX_RX_CRC_LENGTH)
#define DMA_COM_SPI_TX_BURST_EVT                (8)
#define DMA_COM_SPI_TX_TRANSFER_EVT             ((DMA_COM_SPI_TX_RX_FULL_LENGTH - 1) / DMA_COM_SPI_TX_BURST_EVT)
#if (((DMA_COM_SPI_TX_RX_FULL_LENGTH - 1) % DMA_COM_SPI_TX_BURST_EVT) != 0)
#error "error : BURST & TRANSFER are not compatible."
#endif
#define DMA_COM_SPI_RX_BURST_EVT                (1)
#define DMA_COM_SPI_RX_TRANSFER_EVT             (DMA_COM_SPI_TX_RX_FULL_LENGTH / DMA_COM_SPI_RX_BURST_EVT)
#if ((DMA_COM_SPI_TX_RX_FULL_LENGTH % DMA_COM_SPI_RX_BURST_EVT) != 0)
#error "error : BURST & TRANSFER are not compatible."
#endif
...
#define UOMODRI_LSPCLK_FREQ                      DEVICE_SYSCLK_FREQ //DEVICE_LSPCLK_FREQ
//#undef DEVICE_LSPCLK_FREQ
//#define DEVICE_LSPCLK_FREQ          (DEVICE_SYSCLK_FREQ / 1)

#endif /* __UOMODRI_2_HAL_DEFINES_H__ */
